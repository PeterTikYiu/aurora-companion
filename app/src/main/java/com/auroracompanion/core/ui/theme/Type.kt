...
/**
 * Aurora Companion Typography
 * 
 * Material 3 type scale with custom adjustments.
 * Uses system default fonts for maximum compatibility.
 * 
 * Type Scale:
 * - Display: Large, prominent text (rarely used)
